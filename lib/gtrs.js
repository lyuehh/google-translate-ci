...
function trs(word) {
  ...
  token.get(word).then(function(token) {
    var url = 'https://translate.google.cn/translate_a/single?client=t&sl='+sl+'&tl='+tl+'&hl=zh-CN&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t&ie=UTF-8&oe=UTF-8&ssel=3&tsel=6&kc=0&tk='+ token.value +'&q=' + encodeURIComponent(word)
